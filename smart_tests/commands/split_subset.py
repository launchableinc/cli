...
def split_subset(
    ...
    split_by_groups: Annotated[bool, typer.Option(
        "--split-by-groups",
        help="split by groups that were set by `smart-tests record tests --group`"
    )] = False,
    split_by_groups_with_rest: Annotated[bool, typer.Option(
        "--split-by-groups-with-rest",
        help="split by groups that were set by `smart-tests record tests --group` and produces with rest files"
    )] = False,
