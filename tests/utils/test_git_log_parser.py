        ...
        self.assertEqual(
            ...
            [
                GitCommit(
                    ...
                    changed_files=[
                        ChangedFile(
                            path="launchable/commands/subset.py", added=24, deleted=4),
                        ChangedFile(
                            path="launchable/test_runners/gradle.py", added=24, deleted=0),
                        ChangedFile(
                            path="tests/test_runners/test_gradle.py", added=62, deleted=0),
                    ],
                ),
                GitCommit(
                    ...
                    changed_files=[
                        ...
                        ChangedFile(path="docs/SUMMARY.md",
                                    added=1, deleted=0),
                        ChangedFile(
                ...
                GitCommit(
                    ...
                    changed_files=[ChangedFile(
                        path="docs/features/insights/flaky-tests.md", added=2, deleted=2)],
                ),
                GitCommit(
                    ...
                    changed_files=[ChangedFile(
                        path="docs/features/insights/flaky-tests.md", added=3, deleted=3)],
                ),
                GitCommit(
                ...
                GitCommit(
                    ...
                    changed_files=[ChangedFile(
                        path="docs/resources/integrations/maven.md", added=3, deleted=1)],
                ),
                GitCommit(
