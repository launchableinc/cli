...
Now that you've added the CLI to your pipeline, you can start [sending data to Launchable](sending-data-to-launchable.md) to analyze and optimize your test runs.
