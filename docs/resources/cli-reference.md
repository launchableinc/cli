...
| `--time TIME` | Create a fixed time-based subset. \(e.g. `10m` for 10 minutes, `2h30m` for 2.5 hours, `1w3d` for 7+3=10 days. \)  | One of `--target`, `--time` or `--confidence` is required |
