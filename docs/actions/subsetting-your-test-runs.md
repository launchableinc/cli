...
The output from `launchable subset` includes a tip to run `launchable inspect tests`:

```bash
$ launchable subset --build 123 --confidence 90% minitest test/123/*.rb > subset.txt
